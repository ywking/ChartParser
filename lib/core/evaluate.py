...
class SegmentationMetric(object):
    ...
    def linePreRecall(self):
        pre = self.confusionMatrix[1][1]/(self.confusionMatrix[1][1]+self.confusionMatrix[0][1])
        rec = self.confusionMatrix[1][1]/(self.confusionMatrix[1][1]+self.confusionMatrix[1][0])
        return pre, rec, 2*pre*rec/(pre+rec)
